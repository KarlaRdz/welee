...
class ResultsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create result" do
    assert_difference('Result.count') do
      post results_url, params: { result: { answer_id: @result.answer_id, test_id: @result.test_id } }
    end
  ...
  test "should update result" do
    patch result_url(@result), params: { result: { answer_id: @result.answer_id, test_id: @result.test_id } }
